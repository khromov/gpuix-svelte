...
<div class="nav" class:active onclick={go} testId="nav-{label}">
...
<style>
	...
	.count { padding: 0 7px; border-radius: 999px; font-size: 11px; line-height: 16px; pointer-events: none; background-color: var(--well); color: var(--inkMuted); }
</style>
